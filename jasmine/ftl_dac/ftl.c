...
static void format(void)
{
    ...
    mem_set_dram(VBLK_AGE_ADDR, 0, VBLK_AGE_BYTES); // init vblock's age information
/*     mem_set_dram(PAGE_AGE_ADDR, 0, PAGE_AGE_BYTES); // init page's age information - NOT USED */
